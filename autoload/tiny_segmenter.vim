...
" modified for Vim script
" 2023 @kawarimidoll (https://github.com/kawarimidoll/)

function! tiny_segmenter#load_model(json_path = 'ORIGINAL') abort
  let json_path = a:json_path ==# 'ORIGINAL' ? expand(expand('<script>:p:h:h') .. '/models/original.json', v:true)
        \ : a:json_path
